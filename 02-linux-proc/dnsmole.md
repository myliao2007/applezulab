...
| <p> <br>dnsMole program parameters<br>==========================<br><br>  -b &#x3C;file> and -w &#x3C;file> - black/white list filename<br>  -c &#x3C;file>  - configuration filename<br>  -l &#x3C;file>      - define name of log file, if it is not used default dnsmole-log will be used<br>  -i &#x3C;interface> - set interface for sniffing<br>  -s - sniffer mode<br>  -d - run programm in backgroun<br>  -p &#x3C;file> - use .pcap file for analysis<br>  -a &#x3C;interval> - it MUST be used with method 2 in pcap analysis mode, defines interval of .pcap file<br>  -t &#x3C;1|2|3> - analysis method<br><br></p> |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
